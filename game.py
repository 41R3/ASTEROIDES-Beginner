...
pygame.mixer.init(frequency=22050,size=-16,channels=5,buffer=3072)
        ...
        for event in input:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                for i in range(self.percentage):
                    if i == tmp:
                        sonido = pygame.mixer.Sound("sound/gameover.wav")
                        sonido.play()
                        pygame.mixer.music.stop()
                        pygame.mixer.music.load('sound/Titulo.mp3')
        ...
        while i < len(self.asteroids):
            ...
            while j < len(self.ship.bullets):
                if self.asteroids[i].rect.colliderect(self.ship.bullets[j].rect):
                    ...
                    sonido = pygame.mixer.Sound("sound/Explox.ogg")
                    sonido.play()  
                else:
                    j += 1
